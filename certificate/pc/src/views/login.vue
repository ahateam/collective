    ...
    <el-form class="login-form" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        <span class="show-pwd" @click="showPwd">
          <i
            :class="passwordType === 'password' ? 'iconfont course_yanjing_bi' : 'iconfont course_yanjing_kai'"
          />
        </span>
      </el-form-item>
      <el-button
        ...
        methods: {
            ...
            loginBtn(){
                if(this.username == '' || this.password == ''){
                    this.$message.error('请将账号密码输入完整，账号：123;密码：123')
                }else{
                       //登录
