                                ...
                                <div class="box-edit">
                                    ...
                                    <div class="info-table">
                                        ...
                                        <div class="table-center">
                                            <div class="item-th">
                                                <div class="item-th-td" style="width: 14mm;height: 14mm;padding-top:3mm;border-right: 1px solid #aaa">
                                                    <p>抵押</p> <p>日期</p>
                                                </div>
                                                <div class="item-th-td" style="width: 17mm;height: 14mm;padding-top: 3mm;border-right: 1px solid #aaa">
                                                    <p>抵押</p><p>金额</p>
                                                </div>
                                                ...
                                                <div class="item-th-td" style="width: 22mm;height: 17mm;line-height: 17mm;border-right: 1px solid #aaa">
                                                    抵押权人
                                                </div>
                                                <div class="item-th-td" style="width: 14mm;height: 13mm;padding-top: 4mm">
                                                    <p>备案</p><p>签章</p>
                                                </div>
                                            </div>
                                            <div class="item-tr"  v-for="(item,index) in list" :key="index">
                                                <div class="item-th-td" style="width: 14mm;height: 20mm;border-right: 1px solid #aaa">

                                                </div>
                                                <div class="item-th-td" style="width: 17mm;height: 20mm;border-right: 1px solid #aaa">

                                                </div>
                                                <div class="item-th-td" style="width: 14mm;height: 20mm;border-right: 1px solid #aaa;">

                                                </div>
                                                <div class="item-th-td" style="width: 37mm;height: 20mm;border-right: 1px solid #aaa">

                                                </div>
                                                <div class="item-th-td" style="width: 22mm;height: 20mm;border-right: 1px solid #aaa">

                                                </div>
                                                <div class="item-th-td" style="width: 14mm;height: 20mm;">
