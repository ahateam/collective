			...
			<el-row :gutter="40">
				<el-col :span="24" style="margin: 10px 0">
					...
					<el-col :span="18" style="line-height: 4rem">
						<el-select v-model="org" multiple placeholder="不选择默认为所有组织机构" style="margin-left: 20px; width: 100%;">
	...
	export default {
		...
		methods: {
			...
			searchListBtn() {
				...
				this.$area.getVotesByOrgId(cnt, (res) => {
			...
			searchBtn() {
				...
				this.$area.countVoteTurnout(cnt, (res) => {
					if (res.data.rc == this.$util.RC.SUCCESS) {
