    ...
    <div>
        ...
        <el-row class="row-box1">
            ...
            <el-col :span="24" style="margin: 15px 0">
                <el-button type="primary" style="float: right" @click="assetErrorBtn" v-if="status ==1"> 查看错误数据报告
                </el-button>
            </el-col>
        </el-row>
        ...
        mounted() {
            ...
            this.$area.getImportTask(cnt, (res) => {
                if (res.data.rc == this.$util.RC.SUCCESS) {
                    ...
                    if (this.status == '1') {
                        let cnt1 = {
                            orgId: that.info.orgId, // Long 组织编号
                            importTaskId: that.info.id, // Long 导入任务id
                        }
                        this.$area.importAsset(cnt1, (res1) => {
