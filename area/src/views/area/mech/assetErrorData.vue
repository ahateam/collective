        ...
        <el-row class="row-box1" >
            <el-col :span="24">
                ...
                <p>
                    ...
                    任务状态：<span v-if="info.status == 0" style="color: #468847">等待上传文件</span>
                    ...
                    ；错误数据条数：<span style="color: #f44;"> {{info.failureCount}} 条</span>
                        ；成功导入数据条数：<span style="color: #468847;"> {{info.successCount}} 条</span>
                    </span>
                </p>
            </el-col>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.getFailImportRecord(cnt)
            this.percentageData = parseFloat(((this.info.successCount/this.info.amount)*100).toFixed(2))
            ...
            //     importTaskId: this.info.id, // Long 导入任务id
            // }
            // this.$area.getAssetImportTask(cnt1,(res1)=>{
