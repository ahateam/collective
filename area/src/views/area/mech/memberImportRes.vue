        ...
        <el-row class="row-box1">
            ...
            <el-row style="margin: 15px 0">
                <el-col :span="24">
                    ...
                    <el-progress :text-inside="true" :stroke-width="18" :percentage="propressData"
                                 style="line-height: 30px;float: left;width: 300px;margin-left: 20px; "></el-progress>
                </el-col>
            ...
            <el-col :span="24" style="margin: 15px 0">
                <el-button type="primary" style="float: right" @click="assetErrorBtn" v-if="status ==4"> 查看错误数据报告
                </el-button>
            </el-col>
        </el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPropressData() {
                if (this.status != '4') {
                    ...
                    this.$area.getImportTask(cnt, (res) => {
        ...
        mounted() {
            ...
            this.address = 'user/' + this.info.orgId + '/' + this.info.id + '/'
            this.list()
            ...
            console.log('------------------')
            console.log(this.$area.getImportTask)
            this.$area.getImportTask(cnt, (res) => {
                if (res.data.rc == this.$util.RC.SUCCESS) {
                    ...
                    if (this.status == '1') {
                        ...
                        this.$area.importOrgUser(cnt1, (res1) => {
