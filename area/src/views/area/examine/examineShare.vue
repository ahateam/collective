    ...
    <div>
                ...
                <el-col :span="12">
                    ...
                    <el-row style="margin-top: 10px">
                        <el-col :span="24">
                            ...
                            <div class="info-box" style="color: #666;">
        ...
        <el-row class="row-box1">
            <el-col :span="24" style="text-align: center">
                <el-button type="primary" v-if="info.status == 1" @click="passBtn">初审通过</el-button>
                <el-button type="primary" v-if="info.status == 2" @click="editBtn">更改状态为等待领证</el-button>
            </el-col>
        </el-row>
