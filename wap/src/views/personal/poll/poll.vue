                ...
                <div class="vote-item-box">
                  <div class="vote-item-title">
                    ...
                    <div class="vote-item-text">
                      <div class="vote-item-status"></div>
                      <div class="vote-item-title-box">{{item.title}}</div>
                    </div>
                  </div>
                  <div class="vote-item-content">
                    ...
                    <div class="vote-item-info">{{item.remark}}</div>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getStatus() {
      ...
      console.log(ops);
      let passData =
        parseInt(this.quorum * (parseInt(this.info.effectiveRatio) / 100)) + 1;
      let failData =
        parseInt(this.quorum * (parseInt(this.info.failureRatio) / 100)) + 1;

      if (this.waiver >= failData) {
        //无效
        this.status = 0;
      } else {
        //有效
        ...
        if (successType == 1) {
          ...
          if (this.ticketCount == this.quorum) {
            //人到齐了
            this.status = 2; //失败
          } else {
            this.status = -1; //等待投票
