<template>
	<div class="box">
					...
					<el-col :span="24">
						<template>
							<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
								...
								<el-table-column prop="sn" label="资产证件号">
								</el-table-column>
								<el-table-column prop="location" label="位置">
								</el-table-column>

								<el-table-column prop="originPrice" label="价值(万)">
								</el-table-column>
								<el-table-column label="操作">
									<template slot-scope="scope">
										<el-button @click="delBtn(scope.row)" type="text" size="small"><span style="color: #F56C6C;">删除</span></el-button>
										<el-button @click="infoBtn(scope.row,1)" type="text" size="small">详细</el-button>
										<el-button @click="infoBtn(scope.row,2)" type="text" size="small">编辑</el-button>
									</template>
								</el-table-column>
							</el-table>
						</template>
		...
		<!--批量移入资产-->
		<el-dialog title="导入成员" :visible.sync="importModal" width="30%" :before-close="handleClose" center @close="closeBtn">
			<span>
				<div class="file-msg">
		...
		<el-dialog title="新增成员" :visible.sync="addMemberModal" width="60%">
			...
			<div style="text-align: center">
				<el-transfer style="text-align: left; display: inline-block" v-model="assetData" filterable :filter-method="filterMethod"
				 :titles="['所有资产', '选中资产']" :format="{
                            noChecked: '${total}',
				 ...
				 @change="handleChange" :data="assetList">
