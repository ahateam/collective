<template>
    <div>
        ...
        <el-row class="row-box1" >
            <el-col :span="24">
                <p>
                    <span class="info-text">
                        请先将本地的数据表上传至系统中才可继续进行数据的批量录入
                    </span>
                </p>
                <p>
                    <span class="info-text">点击“上传表格”，即可上传需要批量录入的数据，当前页面可以对上传的数据表进行下载查阅和删除</span>
                </p>
                <p>
                    <span class="info-text"> 点击“开始执行批量导入”，即可开始对当前任务下所有的数据表的数据进行读取录入，读取录入过程所需时间稍长，请耐心等待</span>
                </p>
            </el-col>
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <!--<el-button @click="infoBtn(scope.row)" type="text" size="small">导入数据表</el-button>-->
            ...
            <el-col :span="24" style="margin: 15px 0">
                <el-button type="primary" style="float: right" @click="importBtn"> 开始执行批量导入</el-button>
            </el-col>
        </el-row>
    ...
    export default {
        ...
        methods:{
            ...
            downLoadBtn(info){
                ...
                // let url = info.url
                // let _index = url.indexOf('asset')
                //
                // let name = url.slice(50)
                // name = name.replace(this.address,'')
                // name = name.slice(13)
                // name =
                //
                // console.log(name)
