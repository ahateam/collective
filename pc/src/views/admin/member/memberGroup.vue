<template>
	<div class="box">
			...
			<el-col :span="8" style="overflow: hidden">
				<template>
					<el-col :span="24">
						...
						<div style="margin-right:5rem;width:auto;height: 30px;padding: 1rem;border-left: 4px solid #63a35c;font-size: 1.6rem; cursor: pointer;"
						 @click="allUser">全部用户分组</div>
					</el-col>
					<el-col :span="24">
						<el-col :span="24">
							<el-tree v-if="groups != ''" :data="groups" node-key="groupId" :props="defaultProps" default-expand-all
					...
					<el-col :span="24">
						<template>
							<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
								...
								<el-table-column prop="orgUser.familyNumber" label="户序号">
								</el-table-column>
								<el-table-column prop="user.realName" label="姓名">
								</el-table-column>
								<el-table-column prop="user.mobile" label="手机">
								</el-table-column>
								<el-table-column prop="orgUser.roles" label="职务" :formatter="roleFilter">
								</el-table-column>
		...
		<!--批量导入成员-->
		<el-dialog title="导入成员" :visible.sync="importUserModal" width="30%" :before-close="handleClose" center @close="closeBtn">
			<span>
				<div class="file-msg">
		...
		<el-dialog title="移入成员" :visible.sync="addMemberModal" width="60%">
			...
			<div style="text-align: center">
				<el-transfer style="text-align: left; display: inline-block" v-model="addUserList" filterable :filter-method="filterMethod"
				 :titles="['所有成员', '选中成员']" :format="{
                            noChecked: '${total}',
				 ...
				 @change="handleChange" :data="userData">
		...
		<!--删除用户-->
		<el-dialog title="提示" :visible.sync="delModal" width="30%" :before-close="handleClose">
