        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button
                @click="info(scope.row,false)"
                type="text"
                size="small"
                v-if="scope.row.examine == '0' || scope.row.examine == '2'"
              >详情</el-button>
              <el-button
                @click="info(scope.row,true)"
                type="text"
                size="small"
                v-if="scope.row.examine == '1' || scope.row.examine == '3'"
              >详情</el-button>

              <el-button
                @click="editMech(scope.row,false)"
                type="text"
                size="small"
                v-if="scope.row.examine == '0' || scope.row.examine == '2'"
              >修改信息</el-button>
              <el-button
                @click="editMech(scope.row,true)"
                type="text"
                size="small"
                v-if="scope.row.examine == '1' || scope.row.examine == '3'"
              >修改信息</el-button>
