	...
	<div>
		...
		<el-row class="row-box1">
			...
			<el-col :span="24" class="row-box2">
				...
				<el-col :span="18">
					<div class="text-box">
						<el-select v-model="superiorId" filterable remote reserve-keyword placeholder="请输入上级机构名称" :remote-method="getOrgByNameAndLevelBtn"
						 :loading="loading" @focus="superiorBtn">
							<el-option v-for="(item,index) in superiorList" :key="index" :label="item.name" :value="item.id">
							</el-option>
						</el-select>
