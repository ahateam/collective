        ...
        <el-row class="row-box1">
            <el-row >
                <el-col :span="23" style="text-align: right;">
                    <el-button type="primary" size="small" @click=" isEdit =true"><i class="iconfont icon-qianbi"></i> 编辑 </el-button>
                </el-col>
            </el-row>
            <el-row class="row-box2">
                ...
                <el-col :span="18">
                    <el-input v-model="noticeTitle" placeholder="请输入公告标题" :disabled="isEdit == false"></el-input>
                </el-col>
            </el-row>
            <el-row class="row-box2">
                <el-col :span="4">
            ...
            <el-row class="row-box2">
                ...
                <el-col :span="18">
                    <span class="title-text1" >
                        <el-checkbox-group v-model="roles"  :disabled="isEdit == false">
            ...
            <el-row class="row-box2">
                ...
                <el-col :span="18">
                    <span class="title-text1" >
                        <el-checkbox-group v-model="groups"  :disabled="isEdit == false">
            ...
            <el-row class="row-box2" >
                <el-col :span="24" style="text-align: center;line-height: 50px">
                    ...
                    <el-button type="primary" style="margin-left: 20px" @click="editNoticeBtn" v-if="isEdit">修改公告</el-button>
                </el-col>
            </el-row>
        </el-row>
    </div>
...
<script>
    export default {
            ...
            editNoticeBtn(){
                if(this.noticeTitle ==''  || this.noticeContent ==''){
                    ...
                    let cnt = {
                        ...
                        crowd: {orgId:[localStorage.getItem('orgId')],roles: this.roles,groups:this.groups}, // String 人群  例:{orgId:[],roles:[],groups:[]}
                    }
                    this.$api.editNotice(cnt,(res)=>{
        ...
        mounted(){
            ...
            this.noticeTitle = this.info.title
            this.type = this.info.type
            this.noticeContent = this.info.content
            this.roles = JSON.parse(this.info.crowd).roles
            this.groups = JSON.parse(this.info.crowd).groups
